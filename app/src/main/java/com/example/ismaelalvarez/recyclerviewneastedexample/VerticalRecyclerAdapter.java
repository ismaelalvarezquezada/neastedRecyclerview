    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        switch (viewHolder.getItemViewType()) {
            default: {
                ...
                HorizontalRecyclerAdapter adapter = new HorizontalRecyclerAdapter(mList.get(position).gettShirtFeatureList(),mList.get(position).getName());
